...
- short project-owned WAV effects, a full Badinerie lobby loop and separate
  Beethoven G1 match music at126BPM, with persistent Mute/Music controls;
...
`xvfb-run -a make check`. Regenerating music additionally uses Bun 1.4.2:
...
Keyboard layouts join explicitly with 1/2/3; the redundant Join-next-keyboard
button has been removed. Keyboard 1 uses A/D, S, Q/W, left Shift, E and Tab.
When it is the only keyboard player, arrows/comma/period/right Shift/slash also work as aliases.
