...
| Six prototype WAV effects under `internal/sound/audio/` | Generated specifically for Eit 2 by `scripts/generate-audio` | AGPL-3.0-or-later |
...
intentionally no move or rotation sounds.
